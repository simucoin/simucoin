...
{
    // simucoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    // simucoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
