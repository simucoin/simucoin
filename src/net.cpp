...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SimuCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"simucoin.com", "dnsseed.simucoin.com"},
    {NULL, NULL}
};
...
unsigned int pnSeed[] =
{
    ...
    0xB73219B9,0xEE3319B9,0xB5F4FCD5,
    0xC13219B9,0x0CF4FCD5,0x03F92305,
    0xCEFD2305,0x9C713A4D,0xC811A51F,
    0x7132D959,0xE98451AC,
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SimuCoin is probably already running."), addrBind.ToString().c_str());
        else
